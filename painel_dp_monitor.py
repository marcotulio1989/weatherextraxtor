...
def gerar_painel(nome_navio=NOME_NAVIO, lat=LAT_NAVIO, lon=LON_NAVIO, abrir_navegador=True):
    """
    Gera o painel HTML de monitoramento DP.
    
    Args:
        nome_navio: Nome do navio/plataforma
        lat: Latitude do navio
        lon: Longitude do navio
        abrir_navegador: Se True, abre automaticamente no navegador
